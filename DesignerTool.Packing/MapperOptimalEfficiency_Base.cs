...
namespace Mapper
{
    public abstract class MapperOptimalEfficiency_Base<S> : IMapperReturningStats<S> where S : class, ISprite, new()
    {
        ...
        /// <returns></returns>
        public IEnumerable<S> Mapping(IEnumerable<IImageInfo> images)
        {
        ...
        /// <param name="images"></param>
        /// <returns></returns>
        public abstract IEnumerable<S> Mapping(IEnumerable<IImageInfo> images, IMapperStats mapperStats);
        ...
        /// </returns>
        protected virtual IEnumerable<S> MappingRestrictedBox(
            IEnumerable<IImageInfo> images,
            int maxWidth, int maxHeight)
        {
            List<S> lstSprites = new List<S>();

            List<IImageInfo> unfittedImages;
            do
            {
                _canvas = new Canvas();
                ...
                S spriteInfo = new S();
                unfittedImages = new List<IImageInfo>();
