...
namespace DesignerTool.Pages.Shell
{
    public class HomeViewModel : PageViewModel
    {
        ...
        private List<IPanoramaTile> userModule()
        {
            ...
            //tile.TileSelectedAction = () => base.ChangeViewModel(new UserListViewModel());
            ...
            //tile.TileSelectedAction = () => base.ChangeViewModel(new PersonListViewModel());
            ...
            //tile.TileSelectedAction = () => base.ChangeViewModel(new UserGroupListViewModel());
        ...
        private void tileVM_TileSelected(object context)
        {
            if (context != null && context is Type)
            {
                ...
                if (type == typeof(ViewModelBase))
                {
                    ...
                    if (vm != null)
                    {
                        base.ChangeViewModel(context as ViewModelBase);
                    }
                }
            }
        }
