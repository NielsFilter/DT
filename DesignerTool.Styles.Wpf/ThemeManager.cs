...
namespace DesignerTool.Styles.Wpf
{
    /// <summary>
    ...
    public static class ThemeManager
    {
        ...
        public static IEnumerable<Accent> Accents
        {
            get
            {
                ...
                {
                    _accents.Add(new Accent(color, new Uri(string.Format("pack://application:,,,/DesignerTool.Styles.Wpf;component/Styles/Accents/{0}.xaml", color))));
                }
        ...
        public static IEnumerable<AppTheme> AppThemes
        {
            get
            {
                ...
                {
                    var appTheme = new AppTheme(color, new Uri(string.Format("pack://application:,,,/DesignerTool.Styles.Wpf;component/Styles/Accents/{0}.xaml", color)));
