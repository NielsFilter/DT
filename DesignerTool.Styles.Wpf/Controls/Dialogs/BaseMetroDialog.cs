...
namespace DesignerTool.Styles.Wpf.Controls.Dialogs
{
    ...
    public abstract class BaseMetroDialog : ContentControl
    {
        ...
        /// <summary>
        /// Initializes a new DesignerTool.Styles.Wpf.Controls.BaseMetroDialog.
        /// </summary>
        ...
        private void Initialize()
        {
            ...
            this.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/DesignerTool.Styles.Wpf;component/Themes/Dialogs/BaseMetroDialog.xaml") });
