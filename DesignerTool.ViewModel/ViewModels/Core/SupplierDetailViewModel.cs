...
{
    public class SupplierDetailViewModel : PageViewModel
    {
        private SupplierRepository rep;

        #region Constructors

        public SupplierDetailViewModel(IDesignerToolContext ctx)
            : base()
        {
            ...
            this.rep = new SupplierRepository(ctx);
        }

        public SupplierDetailViewModel(IDesignerToolContext ctx, long id)
            : this(ctx)
        {
            this.ID = id;
        }
        ...
        {
            // Go back to list.
            AppSession.Current.Navigate(new SupplierListViewModel(this.rep.Context));
        }
